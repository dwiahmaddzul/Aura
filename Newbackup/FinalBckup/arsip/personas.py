PERSONAS = [
    {
        ...
        "story_prompts": [
            "dreamy pastel sunset over mountains",
            "abstract watercolor painting with gold accents",
            "cozy art studio with canvas and paint",
            "neon graffiti wall in urban alley",
            "close up of paint palette with vibrant colors",
            "minimalist sculpture in white gallery",
            "digital art workspace with drawing tablet",
        ],
    },
    {
        "username": "rizky_dev",
        ...
        "story_prompts": [
            "dark coding setup with neon monitor lights",
            "futuristic tech workspace aesthetic",
            "coffee cup next to laptop with code on screen",
            "server room with blue LED lights",
            "mechanical keyboard closeup with RGB",
            "whiteboard with system architecture diagram",
            "cozy night coding session with rain outside",
        ],
    },
    {
        "username": "nadiafood",
        ...
        "story_prompts": [
            "delicious ramen bowl with steam rising",
            "colorful street food market at night",
            "homemade pasta on rustic wooden table",
            "fresh tropical fruit platter on beach",
            "sizzling BBQ grill closeup with smoke",
            "traditional Indonesian nasi goreng plate",
            "cozy kitchen with morning sunlight and breakfast",
            "bubble tea collection in aesthetic arrangement",
        ],
    },
    {
        "username": "bimo.plays",
        ...
        "story_prompts": [
            "epic gaming setup with RGB lights",
            "retro arcade machine glowing in dark room",
            "controller on desk with energy drink",
            "esports tournament stage with big screens",
            "pixel art character on monitor screen",
            "gaming headset on desk with neon ambiance",
            "collection of game cartridges and consoles",
        ],
    },
    {
        "username": "ara_style",
        ...
        "story_prompts": [
            "aesthetic outfit flatlay on marble background",
            "stylish street fashion photography",
            "minimalist wardrobe closet organization",
            "vintage thrift store interior with racks",
            "sneaker collection arranged artfully",
            "fashion magazine and coffee on bed",
            "handmade jewelry on velvet display",
        ],
    },
    {
        "username": "dimas_photo",
        "display": "Dimas 📸",
        "avatar": "D",
        ...
        "story_prompts": [
            "golden hour city street photography",
            "moody portrait with dramatic lighting",
            "urban night photography with neon signs",
            "rain soaked street reflections at night",
            "silhouette against dramatic sky",
            "abandoned building with light rays through windows",
            "vintage film camera on wooden table",
        ],
    },
]
